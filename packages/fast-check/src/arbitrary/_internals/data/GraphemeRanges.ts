 ...
 */
let autonomousGraphemeRanges: GraphemeRange[] | undefined;
export function getAutonomousGraphemeRanges(): GraphemeRange[] {
  if (autonomousGraphemeRanges === undefined) {
  ...
  return autonomousGraphemeRanges;
}

/**
 * Same as {@link getAutonomousGraphemeRanges} but only made of NFD decomposable graphemes.
 ...
 */
let autonomousDecomposableGraphemeRanges: GraphemeRange[] | undefined;
export function getAutonomousDecomposableGraphemeRanges(): GraphemeRange[] {
  if (autonomousDecomposableGraphemeRanges === undefined) {
  ...
  return autonomousDecomposableGraphemeRanges;
}
