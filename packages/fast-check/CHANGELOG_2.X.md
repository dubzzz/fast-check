...
- ([PR#2593](https://github.com/dubzzz/fast-check/pull/2593)) CI: Trim ANSI modifiers for deploy-netlify
- ([PR#2577](https://github.com/dubzzz/fast-check/pull/2577)) CI: Fix GH action for deploy-netlify
- ([PR#2563](https://github.com/dubzzz/fast-check/pull/2563)) CI: Fix deploy to Netlify
- ([PR#2565](https://github.com/dubzzz/fast-check/pull/2565)) CI: No more external script for reactions
- ([PR#2566](https://github.com/dubzzz/fast-check/pull/2566)) CI: Fully remove external script for reactions
- ([PR#2567](https://github.com/dubzzz/fast-check/pull/2567)) CI: Add "please merge" action
- ([PR#2568](https://github.com/dubzzz/fast-check/pull/2568)) CI: Add "please debug" action
- ([PR#2570](https://github.com/dubzzz/fast-check/pull/2570)) CI: Shorter github-script
- ([PR#2569](https://github.com/dubzzz/fast-check/pull/2569)) CI: Rename netlify "please deploy"
- ([PR#2581](https://github.com/dubzzz/fast-check/pull/2581)) Refactor: Rework set for future optimized comparisons
- ([PR#2562](https://github.com/dubzzz/fast-check/pull/2562)) Typo: Fix typo (deinable -> definable)
