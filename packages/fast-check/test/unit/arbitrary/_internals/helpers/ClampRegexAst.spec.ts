...
describe('clampRegexAst', () => {
  it.each([
    ...
    //{ source: /(cd|efg|h?i[a-z]k*){5,}/, target: /(cd|h{0,0}i[a-z]k{0,0}){5,5}/, maxLength: 10 }, // complex mix
    //{ source: /(ab|(cd|efg|h?i[a-z]k*){5,}){2,}/, target: /(ab|(cd|h{0,0}i[a-z]k{0,0}){5,5}){2,5}/, maxLength: 10 }, // complex mix
