    ...
    fc.assert(
      fc.property(
        ...
        (seed, numValues, biasFactor) => {
          ...
          const refValue: Value<Iterable<Cmd>> = refArbitrary.generate(createRandom(rng), biasFactor);
          ...
          const noExecValue: Value<Iterable<Cmd>> = noExecArbitrary.generate(createRandom(rng), biasFactor);
