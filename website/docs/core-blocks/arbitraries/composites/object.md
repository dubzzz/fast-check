...
// Examples of generated values:
// • Map(9) { 'T>X0Aa]tp>' => ':5+|', '8{0.mI>8R,' => 'j._[Xi&.[', '!83F]'E1_' => 'y[bB,G$_S}', 'NnY,!{' => '6NZ4,G'}', 'Y&>Uj' => 'gg@eTi', 'e>QDNvD/gz' => 'Bt0&oV;', 'ULLW1' => 'F6i_', '?&I' => 'lPd7}', '<H' => '`D? &7A' }
// • Map(6) { 'Yo+"O@q+j' => 'cI{H', '' => '3#$}9{5!z', '?^~k ' => 'w$defipro', '[fa4c' => 'J', '_' => ' y|', '__proto__' => undefined }
// • Map(1) { '~' => '' }
// • Map(1) { 'lzproperty' => '?' }
// • Map(2) { 'hOIY"R q}' => 'W', 'l__defineG' => '8x`:H0?T' }
// • …

fc.map(fc.string(), fc.nat());
// Examples of generated values:
// • Map(9) { '' => 11, '.[hM+$+:?N' => 30, '%{' => 59342696, '|_' => 29, 'E' => 670852246, 'pl_' => 2147483639, '>' => 2147483630, 'M7cU?#9' => 1072636200, 'ot' => 1627183273 }
// • Map(3) { '_G@>x' => 461241683, '@9c=&6H:c0' => 105089967, 'c_)r66nwK' => 1355210745 }
// • Map(1) { '#1O;mZ1' => 1005073225 }
// • Map(0) {}
// • Map(5) { '6' => 144134225, '.9' => 437743867, 'tR?j$Hat3X' => 1920000943, 'DQTd' => 324814916, 'hasOwnProperty' => 2 }
// • …

fc.map(fc.string(), fc.nat(), { minKeys: 2 });
// Note: Generate instances with at least 2 entries
// Examples of generated values:
// • Map(4) { '%{' => 11, '4cH' => 12, 'ke' => 2147483622, 'rqM~i'' => 485910780 }
// • Map(5) { 'K' => 1498847755, '&cP<5:e(y"' => 1430281549, '!"2a' => 1631161561, 'dY+g' => 1880545446, 'M2+^,Yq7~t' => 1437539188 }
// • Map(7) { 'NfXclS' => 815533370, '?' => 2060844890, '' => 1862140278, 'R' => 618808229, 'N|' => 25902062, 'DGw00u?brK' => 348863633, 'constructor' => 18 }
// • Map(2) { ' R~Own' => 2147483645, '~' => 16 }
...
// • Map(1) { 'b' => false }
// • Map(3) { 'b' => false, 'a' => true, 'c' => true }
// • Map(2) { 'c' => false, 'b' => true }
// • …
```
