...
const config: Config = {
  ...
  themeConfig: {
    announcementBar: {
      ...
      content:
        'This documentation is a snapshot of fast-check 4.x and its package ecosystem at the time.<br /><span title="Install commands are preserved as originally documented and may now resolve newer packages.">ⓘ</span> <a href="https://fast-check.dev/">Go to fast-check.dev for the latest major version.</a>',
