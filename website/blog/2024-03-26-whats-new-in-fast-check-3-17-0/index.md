...
<figure>
  ![Simplified workflow of an execution
  before](@site/static/img/blog/2024-03-26-whats-new-in-fast-check-3-17-0--worker-parent-gen.png)
  <figurecaption>
    Simplified workflow of an execution with the main thread responsible for generating the values
  </figurecaption>
</figure>
...
<figure>
  ![Simplified workflow of an execution with worker generating
  values](@site/static/img/blog/2024-03-26-whats-new-in-fast-check-3-17-0--worker-worker-gen.png)
