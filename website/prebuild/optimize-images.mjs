...
const staticAssets = [
  ...
  ['blog/2024-03-26-whats-new-in-fast-check-3-17-0--worker-parent-gen.png', '0f56bf926c1148713f569c83605f99fd509065e5'],
  ['blog/2024-03-26-whats-new-in-fast-check-3-17-0--worker-worker-gen.png', 'b25f964624d7ccaf0cbcf096932e60459afea3f9'],
  ...
  ['socials/fast-check-bun.png', '551bb4219bfd427e2add52fd62f1d4e370eb2aba'],
  ['socials/fast-check-deno.png', 'd0cc1eccb0fda3d4f9ae060330fa45f09709a19c'],
  ['socials/fast-check-jest.png', '2383c635f9a7e8e2b3fa5b54e1603ebb9cb789b8'],
  ['socials/fast-check-nodejs.png', '20e8eb95415362524e43c7c656ebd61466fdff4d'],
  ...
  ['social.png', '728beacd76a9e0c62438d7af6ba39e4534f61bb0'],
];
async function collectAsset(assetName, assetHash, resultingFilePath) {
  ...
  shasum.update(bytes);
  const computedAssetHash = shasum.digest('hex');
  if (assetHash !== computedAssetHash) {
    throw new Error(`Unexpected asset received from ${assetName} got hash=${computedAssetHash}`);
  }
...
async function assessMissingSocialImage() {
  // Only checking socials!
  // With expected pattern from /docs:
