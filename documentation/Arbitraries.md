...
// Examples of generated values:
// • "UP(h)eUP(l)lo wUP(o)UP(r)lUP(d)"
// • "hello UP(w)UP(o)rlUP(d)"
// • "hUP(e)lUP(l)UP(o)UP( )woUP(r)UP(l)d"
// • "UP(h)UP(e)lUP(l)oUP( )UP(w)UP(o)rld"
// • "UP(h)UP(e)lUP(l)oUP( )worUP(l)UP(d)"
// • …
