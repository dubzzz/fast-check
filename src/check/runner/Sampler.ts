...
/**
 * Generate an array containing all the values that would have been generated
 *
 * @example
 * ```typescript
 ...
 * Print the result on `console.log` or `params.logger` (if defined)
 *
 * @example
 * ```typescript
 * fc.statistics(
 ...
 * // The output will be sent line by line to the values defined by logger
 * ```
 *
 * @param generator {@link IProperty} or {@link Arbitrary} to extract the values from
